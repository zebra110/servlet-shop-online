function notification(type, msg, time) {
	...
	var div = "<div class='pop' style='" + pop_style + "'>"
			+ "<div style='float:left'><img src='" + src + type + ".png"
			+ "'></div>" + "<div style='" + msg_style + "'>" + msg + "</div>"
...
// 获得网站根目录
/*
 * function getRootPath(){ var strFullPath = window.document.location.href; var
 * strPath = window.document.location.pathname; var pos =
 * strFullPath.indexOf(strPath); var prePath = strFullPath.substring(0,pos); var
 * postPath = strPath.substring(0,strPath.substr(1).indexOf('/')+1); return
 * prePath+postPath; }
 */
