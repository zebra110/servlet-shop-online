				...
				<div class="col-md-4 w3ls_dresses_grid_left">
					...
					<div class="w3ls_dresses_grid_left_grid">
						<div class="dresses_img_hover">
							<img src="uimages/60.jpg" alt=" " class="img-responsive" />
				...
				<div class="col-md-8 w3ls_dresses_grid_right">
					<div class="col-md-6 w3ls_dresses_grid_right_left">
						<div class="w3ls_dresses_grid_right_grid1">
							<img src="uimages/62.jpg" alt=" " class="img-responsive" />
					...
					<div class="col-md-6 w3ls_dresses_grid_right_left">
						<div class="w3ls_dresses_grid_right_grid1">
							<img src="uimages/61.jpg" alt=" " class="img-responsive" />
					...
					<div class="w3ls_dresses_grid_right_grid3">
						<div class="col-md-12 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								
									
									<c:forEach items="${shops}" var="shops">
										<img src="upload/${shops.sPicture }"  alt=" " class="img-responsive"/>							
									<tr>
										<h5><a href="single.html"><c:out value="${shops.sName}" /></a></h5>
										<!--<td class="common-text required"></td>-->
										<!--<td class="common-text required"><c:out value="${shops.sDate}" /></td>-->
										<p><span>$420</span> <i class="item_price">$<c:out value="${shops.sPrice}" /></i></p>
										<c:choose>
											<c:when test="${shops.sName != null}">
												<div class="simpleCart_shelfItem">
													<p><a class="item_add" href="administer_addorder?id=${shops.id}">Add to cart</a></p>
												</div>
											</c:when>
											<c:otherwise>
					...
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left dresses_grid">
							<div class="hs-wrapper hs-wrapper3">
								<img src="uimages/51.jpg" alt=" " class="img-responsive" />
