		...
		<div class="container">
			...
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<tr class="rem1">
						<td class="invert-image"><a href="single.html"><img src="upload/${orders.sPicture }" alt=" " class="img-responsive" /></a></td>
						<td class="invert"><c:out value="${orders.sName}" /></td>
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                           
									<div class="entry value-minus">&nbsp;</div>
									<div class="entry value"><span><c:out value="${orders.count}" /></span></div>
									<div class="entry value-plus active">&nbsp;</div>
								</div>
							</div>
						</td>
						<td class="invert"><c:out value="${orders.address}" /></td>
						<td class="invert"><c:out value="${orders.sDate}" /></td>
						<td class="invert"><c:out value="${orders.sPrice}" /></td>
						<td class="invert">
							<div class="rem">
			...
			<div class="checkout-left">	
				<div class="checkout-left-basket">
					...
					<ul>
						...
						<li>Total <i>-</i> <span><%=request.getAttribute("result") %></span></li>
					</ul>
				</div>
					...
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left dresses_grid">
							<div class="hs-wrapper hs-wrapper3">
								<img src="uimages/ss1.jpg" alt=" " class="img-responsive">
								<img src="uimages/ss2.jpg" alt=" " class="img-responsive">
								<img src="uimages/ss3.jpg" alt=" " class="img-responsive">
								<img src="uimages/ss4.jpg" alt=" " class="img-responsive">
								<img src="uimages/ss5.jpg" alt=" " class="img-responsive">
								<img src="uimages/ss6.jpg" alt=" " class="img-responsive">
								<img src="uimages/ss7.jpg" alt=" " class="img-responsive">
								<img src="uimages/ss8.jpg" alt=" " class="img-responsive">
					...
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left dresses_grid">
							<div class="hs-wrapper hs-wrapper3">
								...
								<img src="uimages/ss5.jpg" alt=" " class="img-responsive">
								<img src="uimages/ss6.jpg" alt=" " class="img-responsive">
								<img src="uimages/ss9.jpg" alt=" " class="img-responsive">
								<img src="uimages/ss7.jpg" alt=" " class="img-responsive">
								<img src="uimages/ss8.jpg" alt=" " class="img-responsive">
								<div class="w3_hs_bottom">
									<div class="flex_ecommerce">
